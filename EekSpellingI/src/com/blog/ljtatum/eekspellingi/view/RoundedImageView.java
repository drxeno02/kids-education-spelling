...
/**
 * Class is a custom imageView transformer to create rounded
 * and oval shaped images with border padding options
 * @author Tatum
 *
 */
	  ...
	  private Drawable resolveResource() {
		  ...
		  if (mResource != 0) {
			  try {
				  ...
				  e.printStackTrace();
				  Logger.e(TAG, "Unable to find resource: " + mResource + "\n" + e);
				  // do not try again
				  mResource = 0;
			  }
		  }
