package com.blog.ljtatum.eekspellingi.anim;
...
/**
 * Shimmer animation helper class
 * @author Tatum
 *
 */
public class ShimmerViewHelper {
    ...
    /* 
     * shader applied on the text view only null 
     * until the first global layout 
     */
    ...
    private void resetLinearGradient() { 
    	/*
    	 * the gradient is a linear gradient from textColor to reflectionColor. Its axis
    	 * is at the center when it is outside of the view. The outer color (textColor)
    	 * will be repeated (Shader.TileMode.CLAMP) initially. The linear gradient is
    	 * then positioned to the left side of the view
    	 */
